...
import com.contatos.entity.Contato;
...
public class DBAdapter {
	...
	public Contato createContacto(String nome, String email, String telefone, Bitmap foto) {
	...
	private Contato cursorToContacto(Cursor cursor) {
	...
	public Cursor getContactos(){
		Cursor cursor = database.rawQuery("select _id, nome, telefone, foto from contatos", null);
			return cursor;
		}
	public Contato getContacto (int idContacto){
